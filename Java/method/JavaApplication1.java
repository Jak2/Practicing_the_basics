...
abstract class BankAccount{
	...
	double loanAmount;
	final void payloan(double amount){
		loanAmount-=amount;
...
public class JavaApplication1 {
    ...
    public static void main(String[] args) {
		...
		if(num==1){
			System.out.println("Current Balance:"+Account+""+sbacc.balCheck());
		}
		...
		if(sbacc.payloan(pay_loan_amt)>0)
                System.out.println("Transaction Failed!\nplease enter amount greater than 0");
        else
                System.out.println("Transaction Completed!\n loan paid = "+pay_loan_amt+"remaining loan is "+sbacc.payloan());
		}
